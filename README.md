...
| [aws_elasticache_security_group.elasticache](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/elasticache_security_group) | resource |
...
| <a name="input_es_security_group_names"></a> [es\_security\_group\_names](#input\_es\_security\_group\_names) | elasticache-security-group | `string` | `"elasticache-security-group"` | no |
...
| <a name="input_security_group_names"></a> [security\_group\_names](#input\_security\_group\_names) | elasticache-security-group | `string` | `"default"` | no |
